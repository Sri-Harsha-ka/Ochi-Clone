...
function NavBar() {
    return (
        <nav className="px-16 py-8   fixed z-9 top-0 left-0 right-0 backdrop-blur-md z-50">
            <div className="flex justify-between">
                ...
                <div className="navEle font-light text-lg">
                    <ul  className="flex justify-center">
                        <li className="mr-2 ml-2 cursor-pointer">Services</li>
                        <li className="mr-2 ml-2 cursor-pointer">Our Work</li>
                        <li className="mr-2 ml-2 cursor-pointer">About us</li>
                        <li className="mr-2 ml-2 cursor-pointer">Insights</li>
                    </ul>
                </div>
                <div className="contactUs capitalize font-light text-xl">
